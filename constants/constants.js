...
export const specialCharacters = /[\s0-9!@#\$%\^\&*\)\(+=._-]+$/g;
export const onlyDigits = /^[\d\s]+$/;
export const dateFormat = /^\d\d[-/]{1}\d\d$/;
export const fullName = /^(?:((([^0-9_!¡?÷?¿/\\+=@#$%ˆ&*(){}|~<>;:[\]'’,\-.\s])){1,}(['’,\-\.]){0,1}){2,}(([^0-9_!¡?÷?¿/\\+=@#$%ˆ&*(){}|~<>;:[\]'’,\-. ]))*(([ ]+){0,1}(((([^0-9_!¡?÷?¿/\\+=@#$%ˆ&*(){}|~<>;:[\]'’,\-\.\s])){1,})(['’\-,\.]){0,1}){2,}((([^0-9_!¡?÷?¿/\\+=@#$%ˆ&*(){}|~<>;:[\]'’,\-\.\s])){2,})?)*)$/
...
export {emailHandler, nameHandler, passwordHandler}